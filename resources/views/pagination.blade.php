               ...
               <div class="col-md-12">
                ...
                <table class="table table-striped">
                    ...
                    <thead>
                        ...
                        <th class="sorting" data-sorting_type="asc" data-column_name="name" style="cursor:pointer">Name <span id="name_icon"></span></th>
            ...
            $(document).ready(function(){
                ...
                $(document).on('click', '.sorting', function(){
                    ...
                    if(order_type == 'asc'){
                        ...
                        reverse_order = 'desc';
                        $('#'+column_name+'_icon').html('<span>V</span>');
                    }
                    ...
                    if(order_type == 'desc'){
                        ...
                        reverse_order = 'asc';
                       // clear_icon
                        $('#'+column_name+'_icon').html('<span>^</span>');
                    }
